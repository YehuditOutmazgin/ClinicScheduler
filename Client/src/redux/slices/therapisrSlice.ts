...
export const fetchTherapistByIdThunk = createAsyncThunk(
    "therapists/fetchById", // Changed to match the therapist naming convention
...
export const createTherapistThunk = createAsyncThunk(
    "therapists/create", // Changed to match the therapist naming convention
...
export const updateTherapistThunk = createAsyncThunk(
    "therapists/update", // Changed to match the therapist naming convention
    async (therapist: Therapist, { rejectWithValue }) => {
        try {
