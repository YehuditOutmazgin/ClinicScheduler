    ...
    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px" }}>
      ...
      <div className="card">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <div style={{ padding: "12px", background: "var(--pastel-green)", borderRadius: "var(--radius-md)", textAlign: "center", }}            >              <div style={{ fontSize: "24px", fontWeight: "700", color: "var(--dark-green)" }}>                {todayAppointments.length}              </div>              <div style={{ fontSize: "14px", color: "var(--dark-gray)" }}>תורים היום</div>            </div>          </div>        </div>        <div className="card">          <h3 style={{ color: "var(--dark-purple)", marginBottom: "16px" }}>סטטיסטיקות מערכת</h3>          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>            <div style={{ display: "flex", justifyContent: "space-between" }}>              <span>סה"כ מטופלים:</span>              <strong style={{ color: "var(--dark-blue)" }}>{patients.length}</strong>            </div>            <div style={{ display: "flex", justifyContent: "space-between" }}>
