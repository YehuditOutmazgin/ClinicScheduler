...
import { scheduleAppointment, fetchAvailableAppointmentsForTherapistWeek } from "../../store/slices/appointmentSlice"
              ...
              >
                {availableAppointments.map((appointment) => (
                  <button
                    ...
                    className={`btn ${
                      selectedAppointment === appointment.appointmentId ? "btn-primary" : "btn-success"
                    }`}
                    style={{
                      cursor: "pointer",
                    }}
